...
public static class TextPatcher
{
    public static bool ExtractBaseFiles(string pakName, string filter, string extractedPath)
    {
        ...
        else
        {
            ...
            // Set encryption key
            var aes = Global.config.CurrentGame switch
            {
                "Dragon Ball FighterZ" => "b9uW0RKNY91be8HN3Lemi68j6Xsi2l7fQJYsp5oR4al4C4c9kY5E0l90411l9P3L",
    ...
    public static void WriteToFile(Dictionary<string, Entry> dict)
    {
        ...
        // End with footer
        byte[] footer = [0xC1, 0x83, 0x2A, 0x9E];
